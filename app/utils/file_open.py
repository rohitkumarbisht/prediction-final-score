...
def check_file_exists():
    try:
        ...
        linear_model_with_score_exists = os.path.exists(
            'linear_model_with_score.pkl')
        linear_model_without_score_exists = os.path.exists(
            'linear_model_without_score.pkl')
