    ...
    def get(self):
        ...
        try:
            if not selected_column:
                ...
                # Save the image
                png_path = save_image("correlation_with_score_graph.png")
            ...
            if os.path.exists(png_path):
                return render_template("correlation_graph.html", selected_column=selected_column, col_no=not_correlated, col_cor=highly_correlated, graph_path = 'correlation_with_score_graph.png')
            else:
                # 404 Not Found
